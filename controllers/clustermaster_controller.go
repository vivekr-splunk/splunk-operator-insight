...
var ApplyClusterManager = func(ctx context.Context, client client.Client, instance *enterpriseApi.ClusterMaster, provisionerFactory provisioner.Factory) (reconcile.Result, error) {
