...
func (f splunkGatewayFactory) splunkGateway(ctx context.Context, sad *splunkmodel.SplunkCredentials, publisher gateway.EventPublisher) (*splunkGateway, error) {
...
func (f splunkGatewayFactory) NewGateway(ctx context.Context, sad *splunkmodel.SplunkCredentials, publisher gateway.EventPublisher) (gateway.Gateway, error) {
